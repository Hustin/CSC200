...
public class CancelButton { 
	public enum Month {January,February, March, April, May, June, July, August, September, October, November, December}
     public static void main(String[] args) { 
           ...
           Month input = (Month) JOptionPane.showInputDialog(null,"Select a month.", "Month", JOptionPane.INFORMATION_MESSAGE, null, choices, choices[0]); 
	   ...
	   while (input!=null){    		
		...
		input = (Month) JOptionPane.showInputDialog(null,"Select a month.", "Month", JOptionPane.INFORMATION_MESSAGE, null, choices, choices[0]); 	
	    }
	}
}
